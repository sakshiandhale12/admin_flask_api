...
class EppsMiscMstSchema(Schema):
    companyCode = fields.Integer(required=True)
    miscSrNo = fields.Integer(required=True)
    miscMiscCd = fields.String(required=True)
    miscMiscName = fields.String(required=True)
    parentMiscCd = fields.Integer()
    eppsOnlyFlag = fields.String()
    miscValue = fields.String()
    remarks = fields.String()
    createdBy = fields.String()
    createdDt = fields.DateTime()
    updatedBy = fields.String()
    updatedDt = fields.DateTime()
    terminalId = fields.String()
    activeYN = fields.String()
    miscType = fields.String()
    creatorRoleCd = fields.Integer()
    updatorRoleCd = fields.Integer()
    moduleId = fields.String()
    operationDone = fields.String()
    insertAllow = fields.String()

    # Additional validation if needed
    miscMiscCd = fields.String(required=True, validate=validate.Length(max=50))
    miscMiscName = fields.String(required=True, validate=validate.Length(max=100))
    activeYN = fields.String(validate=validate.OneOf(['Y', 'N']))
    # Add more validation as needed

class EppsModuleMstSchema(Schema):
    comp_cd = fields.Integer(dump_only=True)
    module_id = fields.String()
    module_disp_name = fields.String()
    active_yn = fields.String()
    created_by = fields.String()
    created_dt = fields.DateTime()
    updated_by = fields.String()
    updated_dt = fields.DateTime()
    terminal_id = fields.String()
    module_disp_seq_no = fields.Integer()
    creator_role_cd = fields.Integer()
    updator_role_cd = fields.Integer()
    default_access = fields.Integer()
    display_yn = fields.String()
